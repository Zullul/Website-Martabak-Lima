<?php
/**
 * Demo version of Martabak Lima Website without database
 * This shows the full functionality using static data
 */
...
$mockMenuData = [
    ...
    [
        ...
        'image' => 'Martabak_kacangoriginal.jpg',
...
$mockToppings = [
    ['id' => 1, 'name' => 'Daging Sapi', 'price' => 8000, 'category' => 'protein'],
    ['id' => 2, 'name' => 'Ikan Tuna Asap', 'price' => 10000, 'category' => 'protein'],
    ['id' => 3, 'name' => 'Ayam Shredded', 'price' => 6000, 'category' => 'protein'],
    ['id' => 4, 'name' => 'Telur Bebek', 'price' => 3000, 'category' => 'protein'],
    ['id' => 5, 'name' => 'Keju Mozarella', 'price' => 5000, 'category' => 'cheese'],
    ['id' => 6, 'name' => 'Keju Kraft', 'price' => 3000, 'category' => 'cheese'],
    ['id' => 7, 'name' => 'Daun Bawang', 'price' => 1000, 'category' => 'extras'],
    ['id' => 8, 'name' => 'Cabe Rawit', 'price' => 500, 'category' => 'extras'],
    ['id' => 9, 'name' => 'Coklat', 'price' => 2000, 'category' => 'sweet'],
    ['id' => 10, 'name' => 'Keju', 'price' => 3000, 'category' => 'sweet'],
    ['id' => 11, 'name' => 'Kacang', 'price' => 1500, 'category' => 'sweet'],
    ['id' => 12, 'name' => 'Susu Kental Manis', 'price' => 1000, 'category' => 'sweet']
];

// Group toppings by category
$toppingsByCategory = [];
foreach ($mockToppings as $topping) {
...
<head>
    ...
    <title>Martabak Lima - All You Can Mix All You Can Eat (Demo)</title>
...
<body>
    ...
    <!-- Demo Notice -->
    <div class="alert alert-info alert-dismissible fade show rounded-0 border-0" role="alert">
        <div class="container">
            <strong><i class="fas fa-info-circle me-2"></i>Mode Demo:</strong>
            Ini adalah versi demo tanpa database. Untuk versi lengkap dengan admin panel, setup database terlebih dahulu.
    ...
    <section id="menu" class="py-5">
        <div class="container">
            ...
            <div class="row" id="menuContainer">
                <?php foreach ($mockMenuData as $item): ?>
                        ...
                        <div class="card-body">
                            <form id="martabakForm">
                                ...
                                <div class="mb-4" id="proteinSection" style="display: none;">
                                    ...
                                    <div class="row">
                                        <?php 
                                        $proteinToppings = $toppingsByCategory['protein'] ?? [];
                                ...
                                <div class="mb-4" id="extrasSection" style="display: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        $extraToppings = array_merge(
                                            $toppingsByCategory['cheese'] ?? [],
                                            $toppingsByCategory['extras'] ?? []
                                        );
                                ...
                                <div class="mb-4" id="sweetSection" style="display: none;">
                                    ...
                                    <div class="row">
                                        <?php 
                                        $sweetToppings = $toppingsByCategory['sweet'] ?? [];
